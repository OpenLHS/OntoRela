...
CREATE VIEW "ONTORELA_iri"."Person_degreeFrom_University" AS
  SELECT "T588c9ef200_uid" AS "Person_uid",  
    "Td55cd7ab00_uid" AS "University_uid"
  FROM "ONTORELA"."T9aac1f3200";

COMMENT ON VIEW "ONTORELA_iri"."Person_degreeFrom_University" IS 'person has a degree from university::null null null';
