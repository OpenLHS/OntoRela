...
COMMENT ON SCHEMA "PDRO_iri" IS 'Create views with short IRI of PDRO_iri 20240430-1659';
...
COMMENT ON VIEW "PDRO_iri"."OGMS_0000090" IS 'treatment::A processual entity whose completion is hypothesized (by a healthcare provider) to alleviate the signs and symptoms associated with a disorder';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000140" IS 'continuant fiat boundary::b is a continuant fiat boundary = Def. b is an immaterial entity that is of zero, one or two dimensions and does not include a spatial region as part. (axiom label in BFO2 Reference: [029-001])';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000020" IS 'specifically dependent continuant::b is a specifically dependent continuant = Def. b is a continuant & there is some independent continuant c which is not a spatial region and which is such that b s-depends_on c at every time t during the course of b’s existence. (axiom label in BFO2 Reference: [050-003])';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000011" IS 'spatiotemporal region::SpatiotemporalRegion';

CREATE VIEW "PDRO_iri"."BFO_0000144" AS
  SELECT "BFO_0000144_uid" AS "BFO_0000144_uid"
  FROM "PDRO"."BFO_0000144";

COMMENT ON VIEW "PDRO_iri"."BFO_0000144" IS 'process-profile::b is a process_profile =Def. there is some process c such that b process_profile_of c (axiom label in BFO2 Reference: [093-002])';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C33dffb9d" IS 'one-dimensional temporal region
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000146" IS '2d-cf-boundary::TwoDimensionalContinuantFiatBoundary';

CREATE VIEW "PDRO_iri"."BFO_0000038" AS
  SELECT "BFO_0000038_uid" AS "BFO_0000038_uid"
  FROM "PDRO"."BFO_0000038";

COMMENT ON VIEW "PDRO_iri"."BFO_0000038" IS 'one-dimensional temporal region::OneDimensionalTemporalRegion';
...
COMMENT ON VIEW "PDRO_iri"."PDRO_0000321_IAO_0000219_ONTORELA_C33dffb9d" IS 'specification of a part of a drug prescription validity period denotes one-dimensional temporal region
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C33dffb9d_BFO_0000050_PDRO_0000322" IS 'one-dimensional temporal region
