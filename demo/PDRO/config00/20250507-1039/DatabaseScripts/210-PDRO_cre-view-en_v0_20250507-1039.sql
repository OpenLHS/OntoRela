...
COMMENT ON SCHEMA "PDRO_en" IS 'Create views in en of PDRO 20250507-1039';
...
CREATE VIEW "PDRO_en"."three-dimensional spatial region" AS
  SELECT "BFO_0000028_uid" AS "uid three-dimensional spatial region"
  FROM "PDRO"."BFO_0000028";

COMMENT ON VIEW "PDRO_en"."three-dimensional spatial region" IS 'ThreeDimensionalSpatialRegion';
...
COMMENT ON VIEW "PDRO_en"."process" IS 'Process';
...
COMMENT ON VIEW "PDRO_en"."scattered molecular aggregate" IS 'A scattered molecular aggregate is a material entity that consists of all the molecules of a specific type that are located in some bounded region and which is part of a more massive material entity that has parts that are other such aggregates';
...
COMMENT ON VIEW "PDRO_en"."r-quality" IS 'RelationalQuality';
...
COMMENT ON VIEW "PDRO_en"."process boundary" IS 'p is a process boundary =Def. p is a temporal part of a process & p has no proper temporal parts. (axiom label in BFO2 Reference: [084-001])';
...
COMMENT ON VIEW "PDRO_en"."ONTORELA_C3add3bb1" IS 'realizable
...
COMMENT ON VIEW "PDRO_en"."sdc" IS 'SpecificallyDependentContinuant';

CREATE VIEW "PDRO_en"."immaterial" AS
  SELECT "BFO_0000141_uid" AS "uid immaterial"
  FROM "PDRO"."BFO_0000141";

COMMENT ON VIEW "PDRO_en"."immaterial" IS 'ImmaterialEntity';
...
COMMENT ON VIEW "PDRO_en"."planned process" IS 'A process that realizes a plan which is the concretization of a plan specification.';
...
COMMENT ON VIEW "PDRO_en"."ONTORELA_C3addb010" IS 'realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_en"."ONTORELA_C3ad998b9" IS 'realizable
 and (concretizes some 
    (plan specification
...
CREATE VIEW "PDRO_en"."zero-dimensional spatial region" AS
  SELECT "BFO_0000018_uid" AS "uid zero-dimensional spatial region"
  FROM "PDRO"."BFO_0000018";

COMMENT ON VIEW "PDRO_en"."zero-dimensional spatial region" IS 'ZeroDimensionalSpatialRegion';
...
CREATE VIEW "PDRO_en"."value specification has specified numeric value real" AS
  SELECT "OBI_0001933_uid" AS "uid value specification",  
    "OBI_0001933_OBI_0001937_real_OBI_0001937" AS "has specified numeric value"
  FROM "PDRO"."OBI_0001933_OBI_0001937_real";

COMMENT ON VIEW "PDRO_en"."value specification has specified numeric value real" IS 'OBI_0001933 [1..*] OBI_0001937 real';

CREATE VIEW "PDRO_en"."dose range specification has minimum range value rational" AS
...
COMMENT ON VIEW "PDRO_en"."dose range specification has minimum range value rational" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/PDRO_0000133> owl:rational)';

CREATE VIEW "PDRO_en"."OBI_0001931_OBI_0001937_Literal" AS
  SELECT "OBI_0001931_uid" AS "uid scalar value specification",  
    "OBI_0001931_OBI_0001937_Literal_OBI_0001937" AS "has specified numeric value"
  FROM "PDRO"."OBI_0001931_OBI_0001937_Literal";

COMMENT ON VIEW "PDRO_en"."OBI_0001931_OBI_0001937_Literal" IS 'DataMinCardinality(1 <http://purl.obolibrary.org/obo/OBI_0001937> rdfs:Literal)';

CREATE VIEW "PDRO_en"."dose range specification has maximum range value rational" AS
...
COMMENT ON VIEW "PDRO_en"."dose range specification has maximum range value rational" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/PDRO_0000134> owl:rational)';
...
COMMENT ON VIEW "PDRO_en"."realizable realized in process" IS 'RealizableEntity null Process';
...
COMMENT ON VIEW "PDRO_en"."process realizes realizable" IS 'Process null RealizableEntity';
...
COMMENT ON VIEW "PDRO_en"."ONTORELA_C3add3bb1_BFO_0000051_PDRO_0010018" IS 'realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_en"."planned process realizes concretizes some plan specification" IS 'A process that realizes a plan which is the concretization of a plan specification. null planned processA directive information entity with action specifications and objective specifications as parts that, when concretized, is realized in a process in which the bearer tries to achieve the objectives by taking the actions specified.';
...
COMMENT ON VIEW "PDRO_en"."ONTORELA_C3addb010_BFO_0000051_PDRO_0010019" IS 'realizable
 and (concretizes some 
    (plan specification
     and (has part some prophylaxis objective specification)))A directive information entity with action specifications and objective specifications as parts that, when concretized, is realized in a process in which the bearer tries to achieve the objectives by taking the actions specified. A health care objective specification that specifies a prophylaxis. a core relation that holds between a whole and its part A health care objective specification that specifies a prophylaxis.';
...
COMMENT ON VIEW "PDRO_en"."ONTORELA_C3ad998b9_BFO_0000051_PDRO_0010010" IS 'realizable
 and (concretizes some 
    (plan specification
