...
COMMENT ON SCHEMA "PDRO_iri" IS 'Create views with short IRI of PDRO_iri 20250507-1039';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000017" IS 'realizable::RealizableEntity';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000026" IS '1d-s-region::OneDimensionalSpatialRegion';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000145" IS 'r-quality::RelationalQuality';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C40692846" IS 'realizable
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C310d8aaf" IS 'realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000035" IS 'process boundary::p is a process boundary =Def. p is a temporal part of a process & p has no proper temporal parts. (axiom label in BFO2 Reference: [084-001])';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C3eb44fa7" IS 'realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C29e4c3a1" IS 'realizable
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000018" IS 'zero-dimensional spatial region::ZeroDimensionalSpatialRegion';
...
COMMENT ON VIEW "PDRO_iri"."OBI_0001933_OBI_0001937_real" IS 'value specification has specified numeric value real::OBI_0001933 [1..*] OBI_0001937 real';
...
COMMENT ON VIEW "PDRO_iri"."PDRO_0000117_PDRO_0000133_rational" IS 'dose range specification has minimum range value rational::DataExactCardinality(1 <http://purl.obolibrary.org/obo/PDRO_0000133> owl:rational)';
...
COMMENT ON VIEW "PDRO_iri"."OBI_0001931_OBI_0001937_Literal" IS 'scalar value specification has specified numeric value Literal::DataMinCardinality(1 <http://purl.obolibrary.org/obo/OBI_0001937> rdfs:Literal)';
...
COMMENT ON VIEW "PDRO_iri"."PDRO_0000117_PDRO_0000134_rational" IS 'dose range specification has maximum range value rational::DataExactCardinality(1 <http://purl.obolibrary.org/obo/PDRO_0000134> owl:rational)';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000017_BFO_0000054_BFO_0000015" IS 'realizable realized in process::RealizableEntity null Process';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000015_BFO_0000055_BFO_0000017" IS 'process realizes realizable::Process null RealizableEntity';
...
COMMENT ON VIEW "PDRO_iri"."OGMS_0000103_BFO_0000055_ONTORELA_C40692846" IS 'disease prophylaxis realizes realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C40692846_RO_0000059_ONTORELA_C3addb010" IS 'realizable
 and (concretizes some 
    (plan specification
     and (has part some prophylaxis objective specification))) concretizes plan specification
 and (has part some prophylaxis objective specification)::disease prophylaxisRealizableEntity A directive information entity with action specifications and objective specifications as parts that, when concretized, is realized in a process in which the bearer tries to achieve the objectives by taking the actions specified. A health care objective specification that specifies a prophylaxis. A relationship between a specifically dependent continuant and a generically dependent continuant, in which the generically dependent continuant depends on some independent continuant in virtue of the fact that the specifically dependent continuant also depends on that same independent continuant. Multiple specifically dependent continuants can concretize the same generically dependent continuant. realizable
 and (concretizes some 
    (plan specification
     and (has part some prophylaxis objective specification)))A directive information entity with action specifications and objective specifications as parts that, when concretized, is realized in a process in which the bearer tries to achieve the objectives by taking the actions specified. A health care objective specification that specifies a prophylaxis.';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C310d8aaf_RO_0000059_ONTORELA_C3ad998b9" IS 'realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C3add3bb1_BFO_0000051_PDRO_0010018" IS 'plan specification
 and (has part some treatment objective specification) has part treatment objective specification::realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."PDRO_0000100_BFO_0000055_ONTORELA_C29e4c3a1" IS 'drug dispensing process realizes realizable
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C3eb44fa7_RO_0000059_ONTORELA_C3add3bb1" IS 'realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."OGMS_0000090_BFO_0000055_ONTORELA_C3eb44fa7" IS 'treatment realizes realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C3addb010_BFO_0000051_PDRO_0010019" IS 'plan specification
 and (has part some prophylaxis objective specification) has part prophylaxis objective specification::realizable
 and (concretizes some 
    (plan specification
     and (has part some prophylaxis objective specification)))A directive information entity with action specifications and objective specifications as parts that, when concretized, is realized in a process in which the bearer tries to achieve the objectives by taking the actions specified. A health care objective specification that specifies a prophylaxis. a core relation that holds between a whole and its part A health care objective specification that specifies a prophylaxis.';
...
COMMENT ON VIEW "PDRO_iri"."PDRO_0010008_BFO_0000055_ONTORELA_C310d8aaf" IS 'prescribed drug administration realizes realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C3ad998b9_BFO_0000051_PDRO_0010010" IS 'plan specification
 and (has part some health care objective specification) has part health care objective specification::realizable
 and (concretizes some 
    (plan specification
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C29e4c3a1_RO_0000059_PDRO_0000096" IS 'realizable
...
COMMENT ON VIEW "PDRO_iri"."IAO_0000033_IAO_0000136_BFO_0000017" IS 'directive information entity is about realizable::An information content entity whose concretizations indicate to their bearer how to realize them in a process. is_about is a (currently) primitive relation that relates an information artifact to an entity. RealizableEntity';
