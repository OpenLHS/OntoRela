...
COMMENT ON SCHEMA "PDRO_fr" IS 'Création des vue en fr de PDRO 20250507-1039';
...
COMMENT ON VIEW "PDRO_fr"."NCBITaxon_9606
 and (RO_0000053 some OBI_0000093)" IS 'administration de médicament';
...
COMMENT ON VIEW "PDRO_fr"."ONTORELA_C750054bc" IS 'condition de dosage totalUne spécification de valeur de masse indiquant la masse d''un aggrégat d''ingrédient actif. Une spécification de valeur scalaire qui indique un nombre de médicaments. Une spécification de valeur de volume indiquant le volume d''un médicament. Une spécification de valeur de masse qui indique la masse d''un médicament. Une spécification de valeur scalaire qui indique la valeur d''activité biologique d''un aggrégat d''ingrédient actif. Une spécification de quantité de substance où la substance est un aggrégat d''ingrédient actif.';
...
CREATE VIEW "PDRO_fr"."OBI_0001933 OBI_0001937 real" AS
  SELECT "OBI_0001933_uid" AS "uid OBI_0001933",  
    "OBI_0001933_OBI_0001937_real_OBI_0001937" AS "OBI_0001937"
  FROM "PDRO"."OBI_0001933_OBI_0001937_real";

COMMENT ON VIEW "PDRO_fr"."OBI_0001933 OBI_0001937 real" IS 'OBI_0001933 [1..*] OBI_0001937 real';
...
CREATE VIEW "PDRO_fr"."OBI_0001931 OBI_0001937 Literal" AS
  SELECT "OBI_0001931_uid" AS "uid OBI_0001931",  
    "OBI_0001931_OBI_0001937_Literal_OBI_0001937" AS "OBI_0001937"
  FROM "PDRO"."OBI_0001931_OBI_0001937_Literal";

COMMENT ON VIEW "PDRO_fr"."OBI_0001931 OBI_0001937 Literal" IS 'DataMinCardinality(1 <http://purl.obolibrary.org/obo/OBI_0001937> rdfs:Literal)';
...
COMMENT ON VIEW "PDRO_fr"."ONTORELA_C316c7ee9_RO_0000053_OBI_0000093" IS 'administration de médicament null null';
