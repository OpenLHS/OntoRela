...
COMMENT ON SCHEMA "PDRO_iri" IS 'Create views with short IRI of PDRO_iri 20240430-1533';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000015" IS 'process::Process';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000004" IS 'independent continuant::IndependentContinuant';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C44a080fc" IS 'is administered by some (bearer of some health care provider organization role)::health care facilityA role that inheres in an organization and that is realized by the providing of services in a health care encounter.';

CREATE VIEW "PDRO_iri"."BFO_0000028" AS
  SELECT "BFO_0000028_uid" AS "BFO_0000028_uid"
  FROM "PDRO"."BFO_0000028";

COMMENT ON VIEW "PDRO_iri"."BFO_0000028" IS 'three-dimensional spatial region::ThreeDimensionalSpatialRegion';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C316c7ee9" IS 'Homo sapiens
 and (bearer of some patient role)::health care prescriptiona role which inheres in a person and is realized by the process of being under the care of a physician or health care provider';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C5cee9ffd" IS 'facility
 and (is owned by some (bearer of some health care provider organization role))::health care facilityA role that inheres in an organization and that is realized by the providing of services in a health care encounter. An architectural structure that bears some function.';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C6f0acf47" IS 'bearer of some health care provider organization role::health care facilityA role that inheres in an organization and that is realized by the providing of services in a health care encounter.';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000008" IS 'temporal region::TemporalRegion';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000009" IS '2d-s-region::TwoDimensionalSpatialRegion';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000031" IS 'gdc::GenericallyDependentContinuant';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000141" IS 'immaterial::ImmaterialEntity';

CREATE VIEW "PDRO_iri"."BFO_0000020" AS
  SELECT "BFO_0000020_uid" AS "BFO_0000020_uid"
  FROM "PDRO"."BFO_0000020";

COMMENT ON VIEW "PDRO_iri"."BFO_0000020" IS 'sdc::SpecificallyDependentContinuant';
...
COMMENT ON VIEW "PDRO_iri"."OBI_0000011" IS 'planned process::A process that realizes a plan which is the concretization of a plan specification.';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000035" IS 'p-boundary::p is a process boundary =Def. p is a temporal part of a process & p has no proper temporal parts. (axiom label in BFO2 Reference: [084-001])';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000145" IS 'relational quality::b is a relational quality = Def. for some independent continuants c, d and for some time t: b quality_of c at t & b quality_of d at t. (axiom label in BFO2 Reference: [057-001])';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000147" IS '0d-cf-boundary::ZeroDimensionalContinuantFiatBoundary';
...
COMMENT ON VIEW "PDRO_iri"."RO_0000053" IS 'bearer of::a relation between an independent continuant (the bearer) and a specifically dependent continuant (the dependent), in which the dependent specifically depends on the bearer for its existence';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000015_BFO_0000055_BFO_0000017" IS 'process realizes realizable entity::Process null RealizableEntity';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000004_RO_0000087_BFO_0000023" IS 'independent continuant has role role::IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence Role';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000004_RO_0000091_BFO_0000016" IS 'independent continuant has disposition disposition::IndependentContinuant a relation between an independent continuant (the bearer) and a disposition, in which the disposition specifically depends on the bearer for its existence Disposition';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C44a080fc_OMRSE_00000068_ONTORELA_C6f0acf47" IS 'is administered by some (bearer of some health care provider organization role) is administered by bearer of some health care provider organization role::health care facilityA role that inheres in an organization and that is realized by the providing of services in a health care encounter. null is administered by some (bearer of some health care provider organization role)A role that inheres in an organization and that is realized by the providing of services in a health care encounter.';
...
COMMENT ON VIEW "PDRO_iri"."BFO_0000017_BFO_0000054_BFO_0000015" IS 'realizable entity realized in process::RealizableEntity null Process';
...
COMMENT ON VIEW "PDRO_iri"."ONTORELA_C316c7ee9_RO_0000053_OBI_0000093" IS 'Homo sapiens
 and (bearer of some patient role) bearer of patient role::health care prescriptiona role which inheres in a person and is realized by the process of being under the care of a physician or health care provider a relation between an independent continuant (the bearer) and a specifically dependent continuant (the dependent), in which the dependent specifically depends on the bearer for its existence a role which inheres in a person and is realized by the process of being under the care of a physician or health care provider';
...
COMMENT ON VIEW "PDRO_iri"."OMRSE_00000062_RO_0000053_BFO_0000034" IS 'facility bearer of function::An architectural structure that bears some function. a relation between an independent continuant (the bearer) and a specifically dependent continuant (the dependent), in which the dependent specifically depends on the bearer for its existence Function';
...
COMMENT ON VIEW "PDRO_iri"."OBI_0000011_BFO_0000055_ONTORELA_C2875fe2d" IS 'planned process realizes concretizes some plan specification::A process that realizes a plan which is the concretization of a plan specification. null planned processA directive information entity with action specifications and objective specifications as parts that, when concretized, is realized in a process in which the bearer tries to achieve the objectives by taking the actions specified.';
