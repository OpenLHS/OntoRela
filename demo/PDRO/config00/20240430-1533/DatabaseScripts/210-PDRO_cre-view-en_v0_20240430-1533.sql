...
COMMENT ON SCHEMA "PDRO_en" IS 'Create views in en of PDRO 20240430-1533';
...
COMMENT ON VIEW "PDRO_en"."independent continuant" IS 'IndependentContinuant';
...
CREATE VIEW "PDRO_en"."Homo sapiens
 and (bearer of some patient role)" AS
...
COMMENT ON VIEW "PDRO_en"."Homo sapiens
 and (bearer of some patient role)" IS 'health care prescriptiona role which inheres in a person and is realized by the process of being under the care of a physician or health care provider';
...
CREATE VIEW "PDRO_en"."bearer of some health care provider organization role" AS
  SELECT "ONTORELA_C6f0acf47_uid" AS "uid bearer of some health care provider organization role"
  FROM "PDRO"."ONTORELA_C6f0acf47";

COMMENT ON VIEW "PDRO_en"."bearer of some health care provider organization role" IS 'health care facilityA role that inheres in an organization and that is realized by the providing of services in a health care encounter.';
...
CREATE VIEW "PDRO_en"."relational quality" AS
  SELECT "BFO_0000145_uid" AS "uid relational quality"
  FROM "PDRO"."BFO_0000145";

COMMENT ON VIEW "PDRO_en"."relational quality" IS 'b is a relational quality = Def. for some independent continuants c, d and for some time t: b quality_of c at t & b quality_of d at t. (axiom label in BFO2 Reference: [057-001])';
...
CREATE VIEW "PDRO_en"."bearer of" AS
  SELECT "domain_Thing_uid" AS "domain_uid Thing",  
    "range_BFO_0000020_uid" AS "range_uid sdc"
  FROM "PDRO"."RO_0000053";

COMMENT ON VIEW "PDRO_en"."bearer of" IS 'a relation between an independent continuant (the bearer) and a specifically dependent continuant (the dependent), in which the dependent specifically depends on the bearer for its existence';
...
COMMENT ON VIEW "PDRO_en"."process realizes realizable entity" IS 'Process null RealizableEntity';
...
COMMENT ON VIEW "PDRO_en"."independent continuant has role role" IS 'IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence Role';
...
COMMENT ON VIEW "PDRO_en"."independent continuant has disposition disposition" IS 'IndependentContinuant a relation between an independent continuant (the bearer) and a disposition, in which the disposition specifically depends on the bearer for its existence Disposition';

CREATE VIEW "PDRO_en"."ONTORELA_C44a080fc_OMRSE_00000068_ONTORELA_C6f0acf47" AS
  SELECT "ONTORELA_C44a080fc_uid" AS "ONTORELA_C44a080fc_uid",  
    "ONTORELA_C6f0acf47_uid" AS "uid bearer of some health care provider organization role"
  FROM "PDRO"."ONTORELA_C44a080fc_OMRSE_00000068_ONTORELA_C6f0acf47";

COMMENT ON VIEW "PDRO_en"."ONTORELA_C44a080fc_OMRSE_00000068_ONTORELA_C6f0acf47" IS 'health care facilityA role that inheres in an organization and that is realized by the providing of services in a health care encounter. null is administered by some (bearer of some health care provider organization role)A role that inheres in an organization and that is realized by the providing of services in a health care encounter.';
...
COMMENT ON VIEW "PDRO_en"."realizable entity realized in process" IS 'RealizableEntity null Process';
...
COMMENT ON VIEW "PDRO_en"."ONTORELA_C316c7ee9_RO_0000053_OBI_0000093" IS 'health care prescriptiona role which inheres in a person and is realized by the process of being under the care of a physician or health care provider a relation between an independent continuant (the bearer) and a specifically dependent continuant (the dependent), in which the dependent specifically depends on the bearer for its existence a role which inheres in a person and is realized by the process of being under the care of a physician or health care provider';
