...
COMMENT ON SCHEMA "HDRN" IS 'Schéma HDRN créé le 20240430-1533';
...
COMMENT ON CONSTRAINT "fk0_HOSO_0000034" ON "HDRN"."HOSO_0000034" IS 'emergency department outpatient visit -> emergency department visit';
...
COMMENT ON CONSTRAINT "fk0_IOIO_0000011" ON "HDRN"."IOIO_0000011" IS 'human biological sex information content entity -> human biological sex or gender identity information content entity';
...
COMMENT ON CONSTRAINT "fk1_HOSO_0000034" ON "HDRN"."HOSO_0000034" IS 'emergency department outpatient visit -> outpatient visit';
