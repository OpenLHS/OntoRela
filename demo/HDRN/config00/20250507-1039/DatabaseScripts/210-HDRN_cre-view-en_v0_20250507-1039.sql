...
COMMENT ON SCHEMA "HDRN_en" IS 'Create views in en of HDRN 20250507-1039';
...
CREATE VIEW "HDRN_en"."specified value has value Literal" AS
...
COMMENT ON VIEW "HDRN_en"."specified value has value Literal" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/OpenLHS-Core_0000059> rdfs:Literal)';

CREATE VIEW "HDRN_en"."HDRN_0000003_HDRN_0000001_dateTime" AS
...
COMMENT ON VIEW "HDRN_en"."HDRN_0000003_HDRN_0000001_dateTime" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/HDRN_0000001> xsd:dateTime)';

CREATE VIEW "HDRN_en"."unit has textual representation string" AS
  SELECT "OpenLHS-Core_0000057_uid" AS "uid unit",  
...
COMMENT ON VIEW "HDRN_en"."unit has textual representation string" IS 'DataSomeValuesFrom(<http://purl.obolibrary.org/obo/OpenLHS-Core_0000058> xsd:string)';
