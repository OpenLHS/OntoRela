...
COMMENT ON SCHEMA "HDRN" IS 'Schéma HDRN créé le 20250507-1039';
...
CREATE DOMAIN "HDRN"."langString_domain" AS TEXT;

-- Literal_domain domain definition
CREATE DOMAIN "HDRN"."Literal_domain" AS TEXT;

-- anyURI_domain domain definition
CREATE DOMAIN "HDRN"."anyURI_domain" AS TEXT;

-- dateTime_domain domain definition
CREATE DOMAIN "HDRN"."dateTime_domain" AS TIMESTAMP;

-- string_domain domain definition
CREATE DOMAIN "HDRN"."string_domain" AS TEXT;
...
(
  "OpenLHS-Core_0000054_OpenLHS-Core_0000059_Literal_OpenLHS-Core_0000059" "HDRN"."Literal_domain"  NOT NULL, 
  "OpenLHS-Core_0000054_uid" "HDRN"."uid_domain"  NOT NULL,
...
(
  "HDRN_0000003_HDRN_0000001_dateTime_HDRN_0000001" "HDRN"."dateTime_domain"  NOT NULL, 
  "HDRN_0000003_uid" "HDRN"."uid_domain"  NOT NULL,
...
(
  "OpenLHS-Core_0000057_uid" "HDRN"."uid_domain"  NOT NULL, 
  "OpenLHS-Core_0000057_OpenLHS-Core_0000058_string_OpenLHS-Core_0000058" "HDRN"."string_domain"  NOT NULL,
...
COMMENT ON CONSTRAINT "fk0_HOSO_0000019" ON "HDRN"."HOSO_0000019" IS 'public provincial health identifier -> identifier';
...
COMMENT ON CONSTRAINT "fk0_HOSO_0000033" ON "HDRN"."HOSO_0000033" IS 'emergency department inpatient visit -> emergency department visit';
...
COMMENT ON CONSTRAINT "fk0_HOSO_0000043" ON "HDRN"."HOSO_0000043" IS 'ambulance initiated emergency department visit -> emergency department visit';
...
COMMENT ON CONSTRAINT "fk0_IOIO_0000004" ON "HDRN"."IOIO_0000004" IS 'civil death record -> government sanctioned statement';
...
COMMENT ON CONSTRAINT "fk0_OMRSE_00000209" ON "HDRN"."OMRSE_00000209" IS 'gender identity information content entity -> social identity information content entity';
...
COMMENT ON CONSTRAINT "fk0_OGMS_0000031" ON "HDRN"."OGMS_0000031" IS 'disease -> disposition';
...
COMMENT ON CONSTRAINT "fk0_HOSO_0000018" ON "HDRN"."HOSO_0000018" IS 'facility-supported healthcare encounter -> facility-supported clinical visit';
...
COMMENT ON CONSTRAINT "fk1_HOSO_0000033" ON "HDRN"."HOSO_0000033" IS 'emergency department inpatient visit -> inpatient visit';
...
COMMENT ON CONSTRAINT "fk1_IOIO_0000004" ON "HDRN"."IOIO_0000004" IS 'civil death record -> human death statement';
...
COMMENT ON CONSTRAINT "fk1_OGMS_0000031" ON "HDRN"."OGMS_0000031" IS 'disease -> pathological condition';
...
COMMENT ON CONSTRAINT "fk0_HOSO_0000053" ON "HDRN"."HOSO_0000053" IS 'emergency department visit with partial treatment -> visit ended by the patient';
...
COMMENT ON CONSTRAINT "fk0_OGMS_0000045" ON "HDRN"."OGMS_0000045" IS 'disorder -> pathological condition';
...
COMMENT ON CONSTRAINT "fk1_HOSO_0000018" ON "HDRN"."HOSO_0000018" IS 'facility-supported healthcare encounter -> healthcare organization clinical encounter';
...
COMMENT ON CONSTRAINT "fk1_HOSO_0000019" ON "HDRN"."HOSO_0000019" IS 'public provincial health identifier -> specified value';
...
COMMENT ON CONSTRAINT "fk1_HOSO_0000043" ON "HDRN"."HOSO_0000043" IS 'ambulance initiated emergency department visit -> immediate subsequent visit';
...
COMMENT ON CONSTRAINT "fk1_OGMS_0000045" ON "HDRN"."OGMS_0000045" IS 'disorder -> material entity';
...
COMMENT ON CONSTRAINT "fk1_HOSO_0000053" ON "HDRN"."HOSO_0000053" IS 'emergency department visit with partial treatment -> emergency department visit';
...
COMMENT ON CONSTRAINT "fk1_OMRSE_00000209" ON "HDRN"."OMRSE_00000209" IS 'gender identity information content entity -> human biological sex or gender identity information content entity';
...
COMMENT ON CONSTRAINT "fk0_OpenLHS-Core_0000054_OpenLHS-Core_0000059_Literal" ON "HDRN"."OpenLHS-Core_0000054_OpenLHS-Core_0000059_Literal" IS 'specified value has value Literal -> specified value';
...
COMMENT ON CONSTRAINT "fk0_HDRN_0000003_HDRN_0000001_dateTime" ON "HDRN"."HDRN_0000003_HDRN_0000001_dateTime" IS 'HDRN human birth temporal information has HDRN date value dateTime -> HDRN human birth temporal information';
...
COMMENT ON CONSTRAINT "fk0_OpenLHS-Core_0000057_OpenLHS-Core_0000058_string" ON "HDRN"."OpenLHS-Core_0000057_OpenLHS-Core_0000058_string" IS 'unit has textual representation string -> unit';
...
ALTER TABLE "HDRN"."BFO_0000015_OpenLHS-Core_0000067_IAO_0000033"
  ADD CONSTRAINT "fk2_BFO_0000015_OpenLHS-Core_0000067_IAO_0000033" FOREIGN KEY ("BFO_0000015_uid")
    REFERENCES "HDRN"."BFO_0000015" ("BFO_0000015_uid");

COMMENT ON CONSTRAINT "fk2_BFO_0000015_OpenLHS-Core_0000067_IAO_0000033" ON "HDRN"."BFO_0000015_OpenLHS-Core_0000067_IAO_0000033" IS 'process is maximally directed by directive information entity -> process';

-- Foreign key definition : BFO_0000015_OpenLHS-Core_0000067_IAO_0000033 -> IAO_0000033
ALTER TABLE "HDRN"."BFO_0000015_OpenLHS-Core_0000067_IAO_0000033"
  ADD CONSTRAINT "fk3_BFO_0000015_OpenLHS-Core_0000067_IAO_0000033" FOREIGN KEY ("IAO_0000033_uid")
    REFERENCES "HDRN"."IAO_0000033" ("IAO_0000033_uid");

COMMENT ON CONSTRAINT "fk3_BFO_0000015_OpenLHS-Core_0000067_IAO_0000033" ON "HDRN"."BFO_0000015_OpenLHS-Core_0000067_IAO_0000033" IS 'process is maximally directed by directive information entity -> directive information entity';
...
ALTER TABLE "HDRN"."BFO_0000003_RO_0002479_BFO_0000004"
  ADD CONSTRAINT "fk2_BFO_0000003_RO_0002479_BFO_0000004" FOREIGN KEY ("BFO_0000003_uid")
    REFERENCES "HDRN"."BFO_0000003" ("BFO_0000003_uid");

COMMENT ON CONSTRAINT "fk2_BFO_0000003_RO_0002479_BFO_0000004" ON "HDRN"."BFO_0000003_RO_0002479_BFO_0000004" IS 'occurrent has part that occurs in independent continuant -> occurrent';

-- Foreign key definition : BFO_0000003_RO_0002479_BFO_0000004 -> BFO_0000004
ALTER TABLE "HDRN"."BFO_0000003_RO_0002479_BFO_0000004"
  ADD CONSTRAINT "fk3_BFO_0000003_RO_0002479_BFO_0000004" FOREIGN KEY ("BFO_0000004_uid")
    REFERENCES "HDRN"."BFO_0000004" ("BFO_0000004_uid");

COMMENT ON CONSTRAINT "fk3_BFO_0000003_RO_0002479_BFO_0000004" ON "HDRN"."BFO_0000003_RO_0002479_BFO_0000004" IS 'occurrent has part that occurs in independent continuant -> independent continuant';
...
ALTER TABLE "HDRN"."IAO_0000033_OpenLHS-Core_0000066_BFO_0000015"
  ADD CONSTRAINT "fk2_IAO_0000033_OpenLHS-Core_0000066_BFO_0000015" FOREIGN KEY ("IAO_0000033_uid")
    REFERENCES "HDRN"."IAO_0000033" ("IAO_0000033_uid");

COMMENT ON CONSTRAINT "fk2_IAO_0000033_OpenLHS-Core_0000066_BFO_0000015" ON "HDRN"."IAO_0000033_OpenLHS-Core_0000066_BFO_0000015" IS 'directive information entity maximally directs process -> directive information entity';

-- Foreign key definition : IAO_0000033_OpenLHS-Core_0000066_BFO_0000015 -> BFO_0000015
ALTER TABLE "HDRN"."IAO_0000033_OpenLHS-Core_0000066_BFO_0000015"
  ADD CONSTRAINT "fk3_IAO_0000033_OpenLHS-Core_0000066_BFO_0000015" FOREIGN KEY ("BFO_0000015_uid")
    REFERENCES "HDRN"."BFO_0000015" ("BFO_0000015_uid");

COMMENT ON CONSTRAINT "fk3_IAO_0000033_OpenLHS-Core_0000066_BFO_0000015" ON "HDRN"."IAO_0000033_OpenLHS-Core_0000066_BFO_0000015" IS 'directive information entity maximally directs process -> process';
...
ALTER TABLE "HDRN"."IAO_0000030_IAO_0000136_BFO_0000001"
  ADD CONSTRAINT "fk2_IAO_0000030_IAO_0000136_BFO_0000001" FOREIGN KEY ("IAO_0000030_uid")
    REFERENCES "HDRN"."IAO_0000030" ("IAO_0000030_uid");

COMMENT ON CONSTRAINT "fk2_IAO_0000030_IAO_0000136_BFO_0000001" ON "HDRN"."IAO_0000030_IAO_0000136_BFO_0000001" IS 'information content entity is about entity -> information content entity';

-- Foreign key definition : IAO_0000030_IAO_0000136_BFO_0000001 -> BFO_0000001
ALTER TABLE "HDRN"."IAO_0000030_IAO_0000136_BFO_0000001"
  ADD CONSTRAINT "fk3_IAO_0000030_IAO_0000136_BFO_0000001" FOREIGN KEY ("BFO_0000001_uid")
    REFERENCES "HDRN"."BFO_0000001" ("BFO_0000001_uid");

COMMENT ON CONSTRAINT "fk3_IAO_0000030_IAO_0000136_BFO_0000001" ON "HDRN"."IAO_0000030_IAO_0000136_BFO_0000001" IS 'information content entity is about entity -> entity';
