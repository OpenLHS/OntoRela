...
COMMENT ON SCHEMA "HDRN_iri" IS 'Create views with short IRI of HDRN_iri 20250507-1039';
...
COMMENT ON VIEW "HDRN_iri"."HOSO_0000034" IS 'emergency department outpatient visit::There is no expectation of providing support for activities of daily living (such as eating and bathing) nor accommodation for the patient';
...
COMMENT ON VIEW "HDRN_iri"."HOSO_0000041" IS 'healthcare birth visit::In the case of human health the specified organism refers to the child born during the visit.';
...
COMMENT ON VIEW "HDRN_iri"."BFO_0000144" IS 'process profile::b is a process_profile =Def. there is some process c such that b process_profile_of c (axiom label in BFO2 Reference: [093-002])';
...
COMMENT ON VIEW "HDRN_iri"."HOSO_0000045" IS 'healthcare visit of expiration::A healthcare organization clinical visit during which the patient died.';
...
COMMENT ON VIEW "HDRN_iri"."HEPRO_0000011" IS 'health provider role::A role that inheres in an organism as a consequence of training in order to be able to participate as a performer in some health activities.';
...
COMMENT ON VIEW "HDRN_iri"."OpenLHS-Core_0000054_OpenLHS-Core_0000059_Literal" IS 'specified value has value Literal::DataExactCardinality(1 <http://purl.obolibrary.org/obo/OpenLHS-Core_0000059> rdfs:Literal)';
...
COMMENT ON VIEW "HDRN_iri"."HDRN_0000003_HDRN_0000001_dateTime" IS 'HDRN human birth temporal information has HDRN date value dateTime::DataExactCardinality(1 <http://purl.obolibrary.org/obo/HDRN_0000001> xsd:dateTime)';
...
COMMENT ON VIEW "HDRN_iri"."OpenLHS-Core_0000057_OpenLHS-Core_0000058_string" IS 'unit has textual representation string::DataSomeValuesFrom(<http://purl.obolibrary.org/obo/OpenLHS-Core_0000058> xsd:string)';
...
COMMENT ON VIEW "HDRN_iri"."HOSO_0000041_OBI_0000299_ONTORELA_C624fa67d" IS 'healthcare birth visit has_specified_output human birth statement
 and (is about exactly 1 human clinical visit specified patient)::In the case of human health the specified organism refers to the child born during the visit. The inverse property of is_specified_output_of healthcare birth visitA process temporally qualifying statement about the birth of a human including an identifier and a temporal information of the birth of this human.';
...
COMMENT ON VIEW "HDRN_iri"."HEPRO_0000012_RO_0000087_HEPRO_0000011" IS 'health provider has role health provider role::An organism that is the bearer of a health provider role. a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence A role that inheres in an organism as a consequence of training in order to be able to participate as a performer in some health activities.';
...
COMMENT ON VIEW "HDRN_iri"."HEPRO_0000011_RO_0000081_OBI_0100026" IS 'health provider role role of organism::A role that inheres in an organism as a consequence of training in order to be able to participate as a performer in some health activities. a relation between a role and an independent continuant (the bearer), in which the role specifically depends on the bearer for its existence A material entity that is an individual living system, such as animal, plant, bacteria or virus, that is capable of replicating or reproducing, growth and maintenance in the right environment. An organism may be unicellular or made up, like humans, of many billions of cells divided into specialized tissues and organs.';
