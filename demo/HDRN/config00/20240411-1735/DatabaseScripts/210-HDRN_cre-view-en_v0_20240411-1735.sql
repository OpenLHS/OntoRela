...
COMMENT ON SCHEMA "HDRN_en" IS 'Create views in en of HDRN 20240411-1735';
...
COMMENT ON VIEW "HDRN_en"."emergency department outpatient visit" IS 'An emergency department visit and an outpatient visit.';
...
COMMENT ON VIEW "HDRN_en"."process profile" IS 'b process_profile_of c holds when b proper_occurrent_part_of c& there is some proper_occurrent_part d of c which has no parts in common with b & is mutually dependent on b& is such that b, c and d occupy the same temporal region (axiom label in BFO2 Reference: [094-005])';
...
COMMENT ON VIEW "HDRN_en"."health provider role" IS 'This usually includes health professional like physicians, nurses or pharmacists etc.
...
COMMENT ON VIEW "HDRN_en"."healthcare birth visit" IS 'A healthcare organization clinical visit during which a birth statement was produced regarding the birth of the main patient visit beneficiary.';
...
COMMENT ON VIEW "HDRN_en"."healthcare visit of expiration" IS 'A healthcare organization clinical visit during which a death statement was produced regarding the death of the main patient visit beneficiary.';
...
COMMENT ON VIEW "HDRN_en"."health provider has role health provider role" IS 'An organism that is the bearer of a health provider role. a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence This usually includes health professional like physicians, nurses or pharmacists etc.
It could also includes non professionals like patient attendant but it would exclude others like secretaries or accountants.';
...
COMMENT ON VIEW "HDRN_en"."health provider role role of organism" IS 'This usually includes health professional like physicians, nurses or pharmacists etc.
