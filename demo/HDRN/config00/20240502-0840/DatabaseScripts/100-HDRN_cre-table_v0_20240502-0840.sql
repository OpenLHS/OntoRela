...
COMMENT ON SCHEMA "HDRN" IS 'Schéma HDRN créé le 20240502-0840';
...
COMMENT ON CONSTRAINT "fk0_HOSO_0000038" ON "HDRN"."HOSO_0000038" IS 'immediate inpatient subsequent visit -> immediate subsequent visit in same organization';
...
COMMENT ON CONSTRAINT "fk0_IOIO_0000011" ON "HDRN"."IOIO_0000011" IS 'human biological sex information content entity -> specified value';
...
COMMENT ON CONSTRAINT "fk1_IOIO_0000011" ON "HDRN"."IOIO_0000011" IS 'human biological sex information content entity -> human biological sex or gender identity information content entity';
...
COMMENT ON CONSTRAINT "fk1_HOSO_0000038" ON "HDRN"."HOSO_0000038" IS 'immediate inpatient subsequent visit -> inpatient visit';
...
COMMENT ON CONSTRAINT "fk0_OGMS_0000061" ON "HDRN"."OGMS_0000061" IS 'pathological bodily process -> pathological condition';
...
COMMENT ON CONSTRAINT "fk2_IOIO_0000011" ON "HDRN"."IOIO_0000011" IS 'human biological sex information content entity -> biological sex information content entity';
...
COMMENT ON CONSTRAINT "fk0_IOIO_0000002" ON "HDRN"."IOIO_0000002" IS 'civil birth record -> government sanctioned statement';
...
COMMENT ON CONSTRAINT "fk1_OGMS_0000061" ON "HDRN"."OGMS_0000061" IS 'pathological bodily process -> bodily process';
...
COMMENT ON CONSTRAINT "fk1_IOIO_0000002" ON "HDRN"."IOIO_0000002" IS 'civil birth record -> human birth statement';
