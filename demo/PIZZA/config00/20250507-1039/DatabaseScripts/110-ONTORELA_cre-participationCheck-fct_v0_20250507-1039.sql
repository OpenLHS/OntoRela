...
-- Minimum participation ckeck on : T1287e39e00
CREATE OR REPLACE FUNCTION "ONTORELA"."T1287e39e00_checkParticipationMin"("_T815c7dcb00_uid_domain" "ONTORELA"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  (
    (
      ...
      WHERE "T815c7dcb00_uid_domain" = "_T815c7dcb00_uid_domain"
    ) >= 1
  )
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect minimum value %', 'T1287e39e00', 1;
    RETURN FALSE;
  END IF;
END;
$$
...
-- Minimum participation ckeck on : T5dd8fce500
CREATE OR REPLACE FUNCTION "ONTORELA"."T5dd8fce500_checkParticipationMin"("_T33d22c6f00_uid" "ONTORELA"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  ...
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect minimum value %', 'T5dd8fce500', 1;
    RETURN FALSE;
  END IF;
END;
$$
...
-- Minimum participation ckeck on : T10345be000
CREATE OR REPLACE FUNCTION "ONTORELA"."T10345be000_checkParticipationMin"("_Ta2b5425400_uid" "ONTORELA"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  ...
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect minimum value %', 'T10345be000', 1;
    RETURN FALSE;
  END IF;
END;
$$
