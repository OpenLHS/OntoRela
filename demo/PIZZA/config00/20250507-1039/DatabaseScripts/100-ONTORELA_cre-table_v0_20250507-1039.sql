...
-- table T1287e39e00 definition
CREATE TABLE "ONTORELA"."T1287e39e00"
(
  "T815c7dcb00_uid_domain" "ONTORELA"."uid_domain"  NOT NULL, 
  "T815c7dcb00_uid_range" "ONTORELA"."uid_domain"  NOT NULL,
  CONSTRAINT "key_T1287e39e00" PRIMARY KEY ("T815c7dcb00_uid_domain", "T815c7dcb00_uid_range")
);

COMMENT ON COLUMN "ONTORELA"."T1287e39e00"."T815c7dcb00_uid_domain" IS 'uid Food_domain::Default primary key of Food';

COMMENT ON COLUMN "ONTORELA"."T1287e39e00"."T815c7dcb00_uid_range" IS 'uid Food_range::Default primary key of Food';
...
-- table T5dd8fce500 definition
CREATE TABLE "ONTORELA"."T5dd8fce500"
(
  "T33d22c6f00_uid" "ONTORELA"."uid_domain"  NOT NULL, 
  "T361a621000_uid" "ONTORELA"."uid_domain"  NOT NULL,
  CONSTRAINT "key_T5dd8fce500" PRIMARY KEY ("T33d22c6f00_uid", "T361a621000_uid")
);

COMMENT ON COLUMN "ONTORELA"."T5dd8fce500"."T33d22c6f00_uid" IS 'uid Caprina::Default primary key of Caprina';

COMMENT ON COLUMN "ONTORELA"."T5dd8fce500"."T361a621000_uid" IS 'uid TomatoTopping::Default primary key of TomatoTopping';
...
-- table T10345be000 definition
CREATE TABLE "ONTORELA"."T10345be000"
(
  "Ta2b5425400_uid" "ONTORELA"."uid_domain"  NOT NULL, 
  "T361a621000_uid" "ONTORELA"."uid_domain"  NOT NULL,
  CONSTRAINT "key_T10345be000" PRIMARY KEY ("Ta2b5425400_uid", "T361a621000_uid")
);

COMMENT ON COLUMN "ONTORELA"."T10345be000"."Ta2b5425400_uid" IS 'uid Giardiniera::Default primary key of Giardiniera';

COMMENT ON COLUMN "ONTORELA"."T10345be000"."T361a621000_uid" IS 'uid TomatoTopping::Default primary key of TomatoTopping';
...
COMMENT ON CONSTRAINT "fk0_Td2bf94fb00" ON "ONTORELA"."Td2bf94fb00" IS 'CheesyVegetableTopping -> CheeseTopping';
...
COMMENT ON CONSTRAINT "fk1_Td2bf94fb00" ON "ONTORELA"."Td2bf94fb00" IS 'CheesyVegetableTopping -> VegetableTopping';
...
ALTER TABLE "ONTORELA"."T1aa6211f00"
  ADD CONSTRAINT "fk2_T1aa6211f00" FOREIGN KEY ("domain_T7f4f794200_uid", "range_T7f4f794200_uid")
    REFERENCES "ONTORELA"."T31a8bedf00" ("domain_T7f4f794200_uid", "range_T7f4f794200_uid");

COMMENT ON CONSTRAINT "fk2_T1aa6211f00" ON "ONTORELA"."T1aa6211f00" IS 'isBaseOf -> isIngredientOf';

-- Foreign key definition : T31a8bedf00 -> T7f4f794200
ALTER TABLE "ONTORELA"."T31a8bedf00"
  ADD CONSTRAINT "fk3_T31a8bedf00" FOREIGN KEY ("domain_T7f4f794200_uid")
    REFERENCES "ONTORELA"."T7f4f794200" ("T7f4f794200_uid");

COMMENT ON CONSTRAINT "fk3_T31a8bedf00" ON "ONTORELA"."T31a8bedf00" IS 'isIngredientOf -> Thing';

-- Foreign key definition : T31a8bedf00 -> T7f4f794200
ALTER TABLE "ONTORELA"."T31a8bedf00"
  ADD CONSTRAINT "fk4_T31a8bedf00" FOREIGN KEY ("range_T7f4f794200_uid")
    REFERENCES "ONTORELA"."T7f4f794200" ("T7f4f794200_uid");

COMMENT ON CONSTRAINT "fk4_T31a8bedf00" ON "ONTORELA"."T31a8bedf00" IS 'isIngredientOf -> Thing';

-- Foreign key definition : Tbb4ec88700 -> T31a8bedf00
ALTER TABLE "ONTORELA"."Tbb4ec88700"
  ADD CONSTRAINT "fk5_Tbb4ec88700" FOREIGN KEY ("domain_T7f4f794200_uid", "range_T7f4f794200_uid")
    REFERENCES "ONTORELA"."T31a8bedf00" ("domain_T7f4f794200_uid", "range_T7f4f794200_uid");

COMMENT ON CONSTRAINT "fk5_Tbb4ec88700" ON "ONTORELA"."Tbb4ec88700" IS 'isToppingOf -> isIngredientOf';
...
-- Foreign key definition : T1287e39e00 -> T815c7dcb00
ALTER TABLE "ONTORELA"."T1287e39e00"
  ADD CONSTRAINT "fk0_T1287e39e00" FOREIGN KEY ("T815c7dcb00_uid_domain")
    REFERENCES "ONTORELA"."T815c7dcb00" ("T815c7dcb00_uid");

COMMENT ON CONSTRAINT "fk0_T1287e39e00" ON "ONTORELA"."T1287e39e00" IS 'Food hasIngredient Food -> Food';

-- Foreign key definition : T1287e39e00 -> T815c7dcb00
ALTER TABLE "ONTORELA"."T1287e39e00"
  ADD CONSTRAINT "fk1_T1287e39e00" FOREIGN KEY ("T815c7dcb00_uid_range")
    REFERENCES "ONTORELA"."T815c7dcb00" ("T815c7dcb00_uid");

COMMENT ON CONSTRAINT "fk1_T1287e39e00" ON "ONTORELA"."T1287e39e00" IS 'Food hasIngredient Food -> Food';

-- Foreign key definition : T1287e39e00 -> T6bb3915e00
ALTER TABLE "ONTORELA"."T1287e39e00"
  ADD CONSTRAINT "fk2_T1287e39e00" FOREIGN KEY ("T815c7dcb00_uid_domain", "T815c7dcb00_uid_range")
    REFERENCES "ONTORELA"."T6bb3915e00" ("domain_T815c7dcb00_uid", "range_T815c7dcb00_uid");

COMMENT ON CONSTRAINT "fk2_T1287e39e00" ON "ONTORELA"."T1287e39e00" IS 'Food hasIngredient Food -> hasIngredient';
...
-- Foreign key definition : T5dd8fce500 -> T33d22c6f00
ALTER TABLE "ONTORELA"."T5dd8fce500"
  ADD CONSTRAINT "fk0_T5dd8fce500" FOREIGN KEY ("T33d22c6f00_uid")
    REFERENCES "ONTORELA"."T33d22c6f00" ("T33d22c6f00_uid");

COMMENT ON CONSTRAINT "fk0_T5dd8fce500" ON "ONTORELA"."T5dd8fce500" IS 'Caprina hasTopping TomatoTopping -> Caprina';

-- Foreign key definition : T5dd8fce500 -> T361a621000
ALTER TABLE "ONTORELA"."T5dd8fce500"
  ADD CONSTRAINT "fk1_T5dd8fce500" FOREIGN KEY ("T361a621000_uid")
    REFERENCES "ONTORELA"."T361a621000" ("T361a621000_uid");

COMMENT ON CONSTRAINT "fk1_T5dd8fce500" ON "ONTORELA"."T5dd8fce500" IS 'Caprina hasTopping TomatoTopping -> TomatoTopping';

-- Foreign key definition : T5dd8fce500 -> Td4c863da00
ALTER TABLE "ONTORELA"."T5dd8fce500"
  ADD CONSTRAINT "fk2_T5dd8fce500" FOREIGN KEY ("T33d22c6f00_uid", "T361a621000_uid")
    REFERENCES "ONTORELA"."Td4c863da00" ("domain_Taabd98bb00_uid", "range_Tea17570c00_uid");

COMMENT ON CONSTRAINT "fk2_T5dd8fce500" ON "ONTORELA"."T5dd8fce500" IS 'Caprina hasTopping TomatoTopping -> hasTopping';
...
-- Foreign key definition : T10345be000 -> Ta2b5425400
ALTER TABLE "ONTORELA"."T10345be000"
  ADD CONSTRAINT "fk0_T10345be000" FOREIGN KEY ("Ta2b5425400_uid")
    REFERENCES "ONTORELA"."Ta2b5425400" ("Ta2b5425400_uid");

COMMENT ON CONSTRAINT "fk0_T10345be000" ON "ONTORELA"."T10345be000" IS 'Giardiniera hasTopping TomatoTopping -> Giardiniera';

-- Foreign key definition : T10345be000 -> T361a621000
ALTER TABLE "ONTORELA"."T10345be000"
  ADD CONSTRAINT "fk1_T10345be000" FOREIGN KEY ("T361a621000_uid")
    REFERENCES "ONTORELA"."T361a621000" ("T361a621000_uid");

COMMENT ON CONSTRAINT "fk1_T10345be000" ON "ONTORELA"."T10345be000" IS 'Giardiniera hasTopping TomatoTopping -> TomatoTopping';

-- Foreign key definition : T10345be000 -> Td4c863da00
ALTER TABLE "ONTORELA"."T10345be000"
  ADD CONSTRAINT "fk2_T10345be000" FOREIGN KEY ("Ta2b5425400_uid", "T361a621000_uid")
    REFERENCES "ONTORELA"."Td4c863da00" ("domain_Taabd98bb00_uid", "range_Tea17570c00_uid");

COMMENT ON CONSTRAINT "fk2_T10345be000" ON "ONTORELA"."T10345be000" IS 'Giardiniera hasTopping TomatoTopping -> hasTopping';
