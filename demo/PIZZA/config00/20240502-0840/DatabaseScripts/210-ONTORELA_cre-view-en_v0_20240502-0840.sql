...
CREATE VIEW "ONTORELA_en"."Ted5de36500_IceCream_hasIngredient_Food" AS
  SELECT "Ta2f3ba4000_uid" AS "uid IceCream",  
    "T815c7dcb00_uid" AS "uid Food"
  FROM "ONTORELA"."Ted5de36500";

COMMENT ON VIEW "ONTORELA_en"."Ted5de36500_IceCream_hasIngredient_Food" IS 'null null null';
...
CREATE VIEW "ONTORELA_en"."T9f59a5dd00_PizzaBase_hasIngredient_Food" AS
  SELECT "T6c9c3e2c00_uid" AS "uid PizzaBase",  
    "T815c7dcb00_uid" AS "uid Food"
  FROM "ONTORELA"."T9f59a5dd00";

COMMENT ON VIEW "ONTORELA_en"."T9f59a5dd00_PizzaBase_hasIngredient_Food" IS 'null null null';
...
CREATE VIEW "ONTORELA_en"."T8d8358fd00_PizzaTopping_hasIngredient_Food" AS
  SELECT "Tea17570c00_uid" AS "uid PizzaTopping",  
    "T815c7dcb00_uid" AS "uid Food"
  FROM "ONTORELA"."T8d8358fd00";

COMMENT ON VIEW "ONTORELA_en"."T8d8358fd00_PizzaTopping_hasIngredient_Food" IS 'null null null';
