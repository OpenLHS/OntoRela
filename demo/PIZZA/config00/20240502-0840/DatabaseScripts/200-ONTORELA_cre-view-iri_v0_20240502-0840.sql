...
CREATE VIEW "ONTORELA_iri"."IceCream_hasIngredient_Food" AS
  SELECT "Ta2f3ba4000_uid" AS "IceCream_uid",  
    "T815c7dcb00_uid" AS "Food_uid"
  FROM "ONTORELA"."Ted5de36500";

COMMENT ON VIEW "ONTORELA_iri"."IceCream_hasIngredient_Food" IS 'IceCream hasIngredient Food::null null null';
...
CREATE VIEW "ONTORELA_iri"."PizzaBase_hasIngredient_Food" AS
  SELECT "T6c9c3e2c00_uid" AS "PizzaBase_uid",  
    "T815c7dcb00_uid" AS "Food_uid"
  FROM "ONTORELA"."T9f59a5dd00";

COMMENT ON VIEW "ONTORELA_iri"."PizzaBase_hasIngredient_Food" IS 'PizzaBase hasIngredient Food::null null null';
...
CREATE VIEW "ONTORELA_iri"."PizzaTopping_hasIngredient_Food" AS
  SELECT "Tea17570c00_uid" AS "PizzaTopping_uid",  
    "T815c7dcb00_uid" AS "Food_uid"
  FROM "ONTORELA"."T8d8358fd00";

COMMENT ON VIEW "ONTORELA_iri"."PizzaTopping_hasIngredient_Food" IS 'PizzaTopping hasIngredient Food::null null null';
