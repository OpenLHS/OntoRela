...
CREATE OR REPLACE FUNCTION "MONDIAL".T0034_checkParticipationMin(_T0001_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0034_checkParticipationMax(_T0001_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0035_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0035_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0036_checkParticipationMin(_T0015_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0036_checkParticipationMax(_T0015_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0037_checkParticipationMin(_T0001_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0037_checkParticipationMax(_T0001_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0038_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0038_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0039_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0039_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003a_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003a_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003b_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003b_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003c_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003c_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003d_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003d_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003e_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003e_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003f_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T003f_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0040_checkParticipationMin(_T0029_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0040_checkParticipationMax(_T0029_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0041_checkParticipationMin(_T0015_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0041_checkParticipationMax(_T0015_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0042_checkParticipationMin(_T001b_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0042_checkParticipationMax(_T001b_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0043_checkParticipationMin(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0043_checkParticipationMax(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0044_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0044_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0045_checkParticipationMin(_T0023_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0045_checkParticipationMax(_T0023_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0046_checkParticipationMin(_T0015_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0046_checkParticipationMax(_T0015_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0047_checkParticipationMin(_T0008_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0047_checkParticipationMax(_T0008_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0048_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0048_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0049_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0049_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004a_checkParticipationMin(_T002d_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004a_checkParticipationMax(_T002d_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004b_checkParticipationMin(_T002a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004c_checkParticipationMax(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004d_checkParticipationMin(_T002a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004d_checkParticipationMax(_T002a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004e_checkParticipationMin(_T0001_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T004e
CREATE OR REPLACE FUNCTION "MONDIAL".T004e_checkParticipationMax(_T0001_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T004f_checkParticipationMin(_T0003_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0050_checkParticipationMin(_T0003_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0051_checkParticipationMin(_T0004_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0051_checkParticipationMax(_T0004_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0052_checkParticipationMin(_T0004_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0052_checkParticipationMax(_T0004_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0053_checkParticipationMin(_T0007_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T0053
CREATE OR REPLACE FUNCTION "MONDIAL".T0053_checkParticipationMax(_T0007_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  ...
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect maximal value %', 'T0053', 1;
    RETURN FALSE;
  END IF;
END;
$$
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0054_checkParticipationMin(_T0007_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T0054
CREATE OR REPLACE FUNCTION "MONDIAL".T0054_checkParticipationMax(_T0007_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0055_checkParticipationMin(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0056_checkParticipationMin(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0057_checkParticipationMin(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T0057
CREATE OR REPLACE FUNCTION "MONDIAL".T0057_checkParticipationMax(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0058_checkParticipationMin(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T0058
CREATE OR REPLACE FUNCTION "MONDIAL".T0058_checkParticipationMax(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  ...
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect maximal value %', 'T0058', 1;
    RETURN FALSE;
  END IF;
END;
$$
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0059_checkParticipationMin(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005a_checkParticipationMin(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T005a
CREATE OR REPLACE FUNCTION "MONDIAL".T005a_checkParticipationMax(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005b_checkParticipationMin(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T005b
CREATE OR REPLACE FUNCTION "MONDIAL".T005b_checkParticipationMax(_T0009_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005c_checkParticipationMin(_T000a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T005c
CREATE OR REPLACE FUNCTION "MONDIAL".T005c_checkParticipationMax(_T000a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005d_checkParticipationMin(_T000b_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T005d
CREATE OR REPLACE FUNCTION "MONDIAL".T005d_checkParticipationMax(_T000b_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005e_checkParticipationMin(_T000c_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005e_checkParticipationMax(_T000c_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005f_checkParticipationMin(_T000e_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T005f_checkParticipationMax(_T000e_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0060_checkParticipationMin(_T000f_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0060_checkParticipationMax(_T000f_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0061_checkParticipationMin(_T000f_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0062_checkParticipationMin(_T0010_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0062_checkParticipationMax(_T0010_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0063_checkParticipationMin(_T0010_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0063_checkParticipationMax(_T0010_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0064_checkParticipationMin(_T0011_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T0064
CREATE OR REPLACE FUNCTION "MONDIAL".T0064_checkParticipationMax(_T0011_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0065_checkParticipationMin(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0066_checkParticipationMin(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0067_checkParticipationMin(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0068_checkParticipationMin(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0068_checkParticipationMax(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0069_checkParticipationMax(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T006a_checkParticipationMin(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T006a_checkParticipationMax(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T006b_checkParticipationMax(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T006c_checkParticipationMax(_T0014_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T006d_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T006e_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T006f_checkParticipationMin(_T001a_uid_domain "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  (
    (
      SELECT COUNT(*)
      FROM "MONDIAL"."T006f"
      WHERE "T001a_uid_domain" = _T001a_uid_domain
    ) >= 1
  )
  THEN
    RETURN TRUE;
...
-- Maximum participqtion ckeck on : T006f
CREATE OR REPLACE FUNCTION "MONDIAL".T006f_checkParticipationMax(_T001a_uid_domain "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0070_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0071_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0072_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0073_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0074_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0075_checkParticipationMin(_T001a_uid_domain "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0076_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0077_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0078_checkParticipationMin(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0078_checkParticipationMax(_T001a_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0079_checkParticipationMin(_T001c_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T007a
CREATE OR REPLACE FUNCTION "MONDIAL".T007a_checkParticipationMax(_T001f_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T007c_checkParticipationMin(_T0024_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
BEGIN
  ...
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect minimum value %', 'T007d', 2;
    RETURN FALSE;
  END IF;
END;
$$
...
BEGIN
  ...
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect maximal value %', 'T007d', 2;
    RETURN FALSE;
  END IF;
END;
$$
...
-- Maximum participqtion ckeck on : T007e
CREATE OR REPLACE FUNCTION "MONDIAL".T007e_checkParticipationMax(_T0025_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T007f_checkParticipationMin(_T0025_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0080_checkParticipationMin(_T0027_uid_domain "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  (
    (
      SELECT COUNT(*)
      FROM "MONDIAL"."T0080"
      WHERE "T0027_uid_domain" = _T0027_uid_domain
    ) >= 1
  )
  THEN
    RETURN TRUE;
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0081_checkParticipationMin(_T002c_uid_domain "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  (
    (
      SELECT COUNT(*)
      FROM "MONDIAL"."T0081"
      WHERE "T002c_uid_domain" = _T002c_uid_domain
    ) >= 1
  )
  THEN
    RETURN TRUE;
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0082_checkParticipationMin(_T002d_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T0082
CREATE OR REPLACE FUNCTION "MONDIAL".T0082_checkParticipationMax(_T002d_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0083_checkParticipationMin(_T002e_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
CREATE OR REPLACE FUNCTION "MONDIAL".T0084_checkParticipationMin(_T0031_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
...
-- Maximum participqtion ckeck on : T0084
CREATE OR REPLACE FUNCTION "MONDIAL".T0084_checkParticipationMax(_T0031_uid "MONDIAL"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
